    ...
    public class MainViewModel : ViewModelBase
    {
        ...
        private async void OnOpenDetailView(OpenDetailViewEventArgs args)
        {
            ...
            if (detailViewModel == null)
            {
                ...
                {
                    await _messageDialogService.ShowInfoDialogAsync("Could not load the entity. The Navigation is refreshed for you");
                    await NavigationViewModel.LoadAsync();
                    return;
                }
        ...
        {
            RemovedDetailViewModel(args.Id, args.ViewModelName);
        }
        ...
        private void RemovedDetailViewModel(int id, string viewModelName)
        {
            var detailViewModel = DetailViewModels
