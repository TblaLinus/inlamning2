...
namespace FriendOrganizer.UI.ViewModel
{
    class MeetingDetailViewModel : DetailViewModelBase, IMeetingDetailViewModel
    {
        ...
        {
            var result = await MessageDialogService.ShowOkCancelDialogAsync($"Do you want to delete the meeting {Meeting.Title}?", "Question");
        ...
        private void InitializeMeeting(Meeting meeting)
        {
            ...
            if (Meeting.Id == 0)
            {
                Meeting.Title = ""; //Trigger validation
            }
            SetTitle();
        }
